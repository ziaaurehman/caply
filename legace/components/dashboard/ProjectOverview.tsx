...
const ProjectOverview: React.FC = () => {
  ...
  const calculateTimeProgress = (project: typeof projects[0]) => {
  ...
  return (
    <Card className="h-full">
      <CardHeader className="flex flex-row items-center justify-between pb-2">
        ...
        <Link to="/projects" className="text-sm font-medium text-primary-600 hover:text-primary-800 flex items-center">
          View all
