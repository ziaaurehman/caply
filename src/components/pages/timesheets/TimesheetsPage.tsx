...
import { useTimesheetStore, TimesheetEntry } from '@/lib/stores/timesheetStore';
import { useAuthStore } from '@/lib/stores/authStore';
import { useEmployeeStore } from '@/lib/stores/employeeStore';
import { cn } from '@/lib/utils';

interface TimesheetEntryUI {
  projectId: string;
  taskId: string;
  description: string;
  hours: number[];
...
export default function TimesheetsPage() {
  ...
  useEffect(() => {
    ...
    fetchEmployees();
    fetchEntries();
  }, [fetchUser, fetchProjects, fetchEmployees, fetchEntries]);
          ...
          <CardContent>
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {entries
                    .filter((entry: TimesheetEntry) => entry.status === 'submitted')
