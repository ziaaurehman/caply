...
import { Expense } from '@/lib/stores/expenseStore';

interface ExpenseModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (expense: Omit<Expense, 'id' | 'status'> | Expense) => void;
...
export default function ExpenseModal({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (expense) {
      onSubmit({ ...expenseData, id: expense.id, status: expense.status });
    } else {
