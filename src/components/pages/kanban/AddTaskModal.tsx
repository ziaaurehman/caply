...
export default function AddTaskModal({ isOpen, onClose, onSave, listId, projectMembers }: AddTaskModalProps) {
            ...
            <div className="flex flex-wrap gap-2">
              {coverColors.map((color) => (
                <button
                  key={color.value}
                  type="button"
                  onClick={() => setFormData(prev => ({ ...prev, cover_color: color.value }))}
