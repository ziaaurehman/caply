...
export default function LabelsModal({
  ...
  const [localSelectedLabels, setLocalSelectedLabels] = useState<string[]>(selectedLabels)
  ...
  const handleLabelToggle = (labelId: string) => {
    ...
    console.log("Label toggle:", labelId, "isSelected:", isSelected, "current selected:", localSelectedLabels)
    if (isSelected) {
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md max-h-[80vh] overflow-hidden">
        ...
        {showCreateForm ? (
          <div className="p-4 border-t border-gray-200">
            <h3 className="text-sm font-medium text-gray-700 mb-3">Create a new label</h3>
