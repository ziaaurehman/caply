...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    outline: 'bg-transparent hover:bg-gray-50 border border-gray-300 text-gray-700 focus:ring-primary-500',
  ...
  return (
    <button
      className={cn(
        'relative inline-flex items-center justify-center rounded-md font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors',
