...
import { Users, BarChart3, TrendingUp, Clock, Eye, Download } from "lucide-react"
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          ...
          <div className="text-xs text-gray-500 text-center leading-tight">
            {centerLabel.includes(" ")
              ? centerLabel.split(" ").map((word, index) => <div key={index}>{word}</div>)
              : centerLabel}
          </div>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Overview of your resources, projects, and capacity.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                      ...
                      >
                        <div className="col-span-4">
                          <div className="flex items-center">
                            <div className={`h-3 w-3 rounded-full ${project.color} mr-3 flex-shrink-0`}></div>
                        ...
                        <div className="col-span-2">
                          <div className="flex items-center">
                            ...
                            <span className="text-sm text-gray-900 whitespace-nowrap">{project.progress}% / 100%</span>
                          </div>
                        </div>
                        <div className="col-span-3">
                          <div className="text-sm text-gray-900">${project.budget.spent.toLocaleString()} /</div>
                          <div className="text-sm text-gray-900">${project.budget.total.toLocaleString()}</div>
                          <div className="text-sm text-green-600">+${project.budget.remaining.toLocaleString()}</div>
                        </div>
                        <div className="col-span-2">
                          <div className="text-sm text-gray-900">-{project.timeline.daysLeft} days left</div>
                          <div className="text-sm text-gray-500">{project.timeline.endDate}</div>
                        </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 h-[500px] flex flex-col">
              <div className="px-6 py-4 border-b border-gray-200 flex-shrink-0">
                <div className="flex items-center justify-between">
                  <h2 className="text-lg font-medium text-gray-800">Team Capacity Overview</h2>
                  <span className="text-sm text-orange-600 font-medium">Available</span>
                </div>
              </div>
              <div className="p-6 flex-1 flex flex-col overflow-hidden">
                <div className="flex-1 overflow-y-auto">
                    ...
                    {teamMembers.map((member) => (
                      <div key={member.id} className="space-y-3">
                        <div className="flex items-center justify-between">
                          ...
                          <span className={`text-sm font-medium ${getUtilizationTextColor(member.status)}`}>
                            {member.utilization}%
                          </span>
                        </div>
                        ...
                        <div className="relative">
                          ...
                          <p className="text-xs text-gray-500 mt-1">{member.hours}</p>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="pt-4 border-t border-gray-200 flex-shrink-0">
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    <div className="flex items-center space-x-1">
                      ...
                      <span className="text-gray-600">Overallocated ({">"}100%)</span>
                    </div>
                    <div className="flex items-center space-x-1">
                    ...
                    <div className="flex items-center space-x-1">
                      ...
                      <span className="text-gray-600">Available ({"<"}70%)</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-lg font-medium text-gray-800">Project Resource Distribution</h2>
          </div>
          <div className="p-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              <div className="text-center">
                <h3 className="text-sm font-medium text-gray-700 mb-6">Project Allocation</h3>
                <DonutChart data={projectAllocationData} centerValue="2" centerLabel="Active Projects" />
              ...
              <div className="text-center">
                <h3 className="text-sm font-medium text-gray-700 mb-6">Skill Distribution</h3>
                <DonutChart data={skillDistributionData} centerValue="4" centerLabel="Unique Roles" />
                <div className="mt-6 space-y-3">
              ...
              <div className="text-center">
                <h3 className="text-sm font-medium text-gray-700 mb-6">Workload Distribution</h3>
                <DonutChart data={workloadDistributionData} centerValue="0" centerLabel="Optimally Allocated" />
                <div className="mt-6 space-y-3">
