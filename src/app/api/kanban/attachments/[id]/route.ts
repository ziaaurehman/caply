...
export async function DELETE(
  ...
  try {
    ...
    const attachmentOrgId = (existingAttachment.cards as any).lists.boards.projects.organization_id;
...
export async function GET(
  ...
  try {
    ...
    // Get the organization ID from the attachment
    const attachmentOrgId = (attachment.cards as any).lists.boards.projects.organization_id;
