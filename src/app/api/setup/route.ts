  ...
  try {
    ...
    const roles = [
      ...
      },
      {
        ...
        description:
          "Can track time, submit expenses, and work on assigned projects",
        is_system_role: false,
      },
      {
        name: "guest",
    ...
    const { data: insertedPermissions, error: permissionsError } =
      await supabase
        .from("permissions")
